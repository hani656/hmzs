<template>
  <div class="building-container">
    ...
    <div class="search-container">
      ...
      <el-input v-model="params.name" clearable placeholder="请输入员工姓名" class="search-main" />
    ...
    <div class="table">
      <el-table style="width: 100%" :data="employeeList">
        ...
        <el-table-column label="员工姓名" width="320" prop="name" />
...
<script>
import { getEmployeeListAPI, createEmployeeAPI, getRoleListAPI, delEmployeeAPI } from '@/api/system'
