  ...
  <div class="card-container">
    ...
    <div class="search-container">
      ...
      <!--
        ...
        el-option: 下拉框中的每一项 label（中文显示） / value（选中之后赋值给v-model的数据将来传给后端）
       -->
    ...
    <div class="table">
      <el-table style="width: 100%" :data="list" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="车辆品牌" prop="totalEffectiveDate" />
        <el-table-column label="剩余有效天数" prop="carBrand" />
        <!--
          实现目标：
          0 - 有效
          1 - 已过期
         -->
        <el-table-column label="状态" prop="cardBrnd" :formatter="formatStatus" />
...
export default {
  ...
  methods: {
    ...
    async delAllCard() {
      ...
      // 3.调用接口需要做数据处理 把对象数组中的每一项的id拿到 拼接成逗号分隔的写法
